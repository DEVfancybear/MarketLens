...
export const DRAWING_TOOL_MANIFEST = Object.freeze([
  tool("cursor", "Cursor", "cursor", "cursor", "mode", 0, { favoriteEligible: true, modeInteraction: "selection", shortcuts: [{ key: "1", shiftKey: true }] }),
  ...
  tool("rectangle", "Rectangle", "shapes", "square", "two-point", 2, { shortcuts: [{ key: "4", shiftKey: true }, { key: "r", altKey: true, shiftKey: true }], section: "SHAPES", styleFamily: "shape", selectionTextEditor: "shape-center", settingsFeatures: ["line", "fill", "text", "middle-line", "coordinates", "visibility", "templates"], alertProjection: "range-boundaries" }),
  ...
  tool("polyline", "Polyline", "shapes", "pen", "click-freeform", 2, { shortcuts: [{ key: "5", shiftKey: true }] }),
  ...
  tool("fibRetracement", "Fib Retracement", "fibonacci", "fib", "two-point", 2, { shortcuts: [{ key: "7", shiftKey: true }], settingsProfile: "fib", alertProjection: "fib-retracement-levels" }),
  ...
  tool("text", "Text", "annotations", "text", "one-point", 1, { shortcuts: [{ key: "6", shiftKey: true }], styleFamily: "text", overlayExtension: "text-editor" }),

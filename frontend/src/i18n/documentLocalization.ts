...
export const EN_UI_COPY: Readonly<Record<string, string>> = {
  ...
  "Hướng dẫn cài SMCExecutionEA": "SMCExecutionEA setup guide",
  ...
  "Tải SMCExecutionEA.ex5": "Download SMCExecutionEA.ex5",
  ...
  "Kéo SMCExecutionEA vào đúng một chart trong terminal.": "Attach SMCExecutionEA to exactly one chart in the terminal.",

...
Architecture and design documentation for the SMC Trading Terminal frontend.
...
| `CHART_TIME_NAVIGATION_ARCHITECTURE.md`  | Chart time navigation system           |
| `CHART_VISUAL_PROFILE.md`                | Chart visual profile / rendering       |
| `INDICATOR_ARCHITECTURE.md`              | Indicator system design                |
...
## Drawing Debug / Root Cause

| File                                  | Topic                                  |
| ------------------------------------- | -------------------------------------- |
| `DRAWING_ENGINE_ROOT_CAUSE.md`        | Root cause analysis                    |
...
| `DRAWING_REGRESSION_AUDIT.md`         | Regression audit findings              |
...
| `POSITION_TOOL_ARCHITECTURE.md` | Position tool design                   |

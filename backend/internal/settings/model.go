...
var (
	...
	defaultChartJSON = json.RawMessage(`{"symbol":"EURUSD","timeZone":"exchange","drawingSyncMode":"chart-only","drawingSyncModeVersion":2,"drawingToolPreferences":{"version":1,"keepDrawing":false,"magnetEnabled":false,"magnetMode":"weak","toolDefaults":{"emoji":{"text":"😊","fontSize":32}},"emojiSelection":{"kind":"emoji","value":"😊"},"emojiRecents":[]}}`)
)
